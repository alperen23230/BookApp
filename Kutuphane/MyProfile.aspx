<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyProfile.aspx.cs" Inherits="Kutuphane.MyProfile" %>
...
<body>
    <form id="form1" runat="server">
        <div id="navbar">
            ...
            <ul id="navmenu">
                <li class="navmenu"><a href="Mesajlarim.aspx">Mesajlarım</a></li>
                <li class="navmenu"><a href="Giris.aspx">Çıkış Yap</a></li>
            </ul>
        </div>
